...
var helpDescsEnUS = map[string]string{
	...
	"importpubkey--synopsis": "Imports a SEC-encoded public key to the 'imported' account",
	...
	"importpubkey-rescan":    "Rescan the blockchain (since the genesis block, or scanfrom block)",
